...
![Ввод данных в файл выглядит так: сначала идёт слово "points", затем перечисляются координаты точек, слово "circles", перечисление координат центров и точек на соответственных окружностях, в конце ставится 0](/Files/Image1.PNG")
